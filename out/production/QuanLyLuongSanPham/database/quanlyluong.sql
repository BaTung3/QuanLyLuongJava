...
UPDATE PhongBan
SET TENPHONGBAN =N'Phòng Nhân Sự'
WHERE TENPHONGBAN =N'Ban Quản Lý';

UPDATE PhongBan
SET TENPHONGBAN =N'Phòng Kinh Doanh'
WHERE TENPHONGBAN =N'Ban Sản Xuất';
...
]([TENCA],[GIOLAM],[CALAM],[LUONGCA])

INSERT INTO CaLamViec
VALUES
('1',N'Sáng 1', '7:00 - 9:00', '1', 1000000),
('2',N'Sáng 2', '9:30 - 12:30', '2', 1000000),
('3',N'Sáng 3', '1:00 - 3:00', '3', 1000000),
('4',N'Sáng 4', '3:30 - 5:30', '4', 1200000),
('5',N'Sáng 5', '6:00 - 9:00', '5', 1200000)
